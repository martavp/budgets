...
color={'25.7':'yellowgreen',
     ...
     '64.3':'darkred',
     '73.9':'magenta',
     '45.0-noH2network':'gold',
     '45.0-endo_efficiency':'gold',
     '45.0-nobiomassCC':'gold',}
...
version='baseline' #'sensitivity-costs2' #'sensitivity-costs' #'baseline' #'sensitivity-fixedcosts'
sensitivity_cost_option= '' #'-DAC+c1.2'
...
for budget in budgets:
    ...
    for i,metric in enumerate(metrics):
        ...
        ax1.plot([2020, sel_year+x_pos[budget]], [len(metrics) - i, len(metrics) - i], 
                 linewidth=30,
                 color=color[budget],
#                 markersize=20,
